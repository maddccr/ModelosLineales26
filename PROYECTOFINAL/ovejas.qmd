...
ggplot(datos_preparto, aes(x = Gainseñal)) +
  geom_density(fill = "#b9257a", alpha = 0.4) +
...
#LASSO :0
x_matrix <- model.matrix(Gainseñal ~ Edad + Partos + Pesove + CCove + LOTE + Tiponac + Potrepari + Sex + Nodu + Induru + Eco + Lagubre + Ancubre + Anchopez + Largopez + Peznum + Suspen + Separ + Ubicpez + Simet, data = datos_preparto)[, -1]
