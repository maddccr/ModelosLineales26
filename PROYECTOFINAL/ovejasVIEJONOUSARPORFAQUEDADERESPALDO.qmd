...
ggplot(df, aes(x = i, y = h_i)) +
  ...
  scale_color_manual(
  values = c("#b9257a", "#faa476"),
  labels = c("Leverage normal", "Alto leverage"),
  name = ""
) +
...
#modelo sin la obs. 43
datos_43 <- datos_preparto[-43, ]
...
round(
  cbind(
    Original = coef(modelin),
    Sin43 = coef(modelo_43)
  ),
  4
)
#comparando con modelin hay un cambio leve en el R cuadrado ajustado, y comparando no e
```
